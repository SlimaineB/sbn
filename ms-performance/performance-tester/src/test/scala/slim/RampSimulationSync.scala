...
//Run command : mvn gatling:test -Dgatling.simulationClass=slim.RampSimulationSync
class RampSimulationSync extends Simulation {
	...
	val scn = scenario("RampSimulationSync")
		.exec(http("request_0")
