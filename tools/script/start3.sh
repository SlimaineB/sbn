#!/bin/sh
# https://www.topjavablogs.com/news/how-to-make-spring-boot-application-start-when-linux-boots
### BEGIN INIT INFO
...
PATH_TO_JAR=/ABSOLUTE_PATH_TO_YOUR_APP/YOUR_APP_NAME.jar
OPTS="-Xmx256m"
PID_PATH_NAME=/tmp/YOUR_APP_NAME-pid
case $1 in
    start)
